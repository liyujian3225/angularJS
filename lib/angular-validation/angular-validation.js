  ...
  function Validator($injector) {
    ...
    return {
      ...
      link: function(scope, element, attrs, ctrl) {
        ...
        var html = '<span ng-show="isShowTips"></span>';
        var temp = compile(html)(scope)
        if (!scope.messageId) element.before(temp);
      ...
      /**
       * valid focus method                  
       * author:wangjiang  2015-11-10
       */
        if(attrs.validMethod === 'focus'){
